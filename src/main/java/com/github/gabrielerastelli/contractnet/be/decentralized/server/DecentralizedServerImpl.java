package com.github.gabrielerastelli.contractnet.be.decentralized.server;
...
@Getter
@Setter
public class DecentralizedServerImpl extends IServer {


    List<ServerUpdateListener> listeners;

    public DecentralizedServerImpl(String ip, int numberOfThreads, List<ServerUpdateListener> listeners) {
